...
class FootballField:
    ...
    def set_football_field(self):
        ...
        football_fields_array = get_batabase(f"SELECT name FROM HAGZ.football_field;")
        ...
        football_fields_array = get_batabase(f"SELECT * FROM HAGZ.football_field WHERE admin_id = {self.admin_id};")
